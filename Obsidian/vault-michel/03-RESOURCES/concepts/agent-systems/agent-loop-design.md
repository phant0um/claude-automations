...
- **[2026-06-28]** Loop engineering = 4º andar acima do harness. 5 moves: discovery, handoff, verification, persistence, scheduling. Generator/Evaluator split: evaluator independente cético > generator auto-crítico. 4 custos silenciosos: verification debt, comprehension rot, cognitive surrender, token blowout — [[loop-engineering-ieee-field-study]]
- **[2026-06-28]** Wiki LLM (Karpathy): conhecimento compilado uma vez e mantido atual, não re-derivado a cada query. Filesystem como substrate de memória: names, paths, hierarchy, timestamps que o modelo sabe raciocinar — [[self-improving-company-brain-claude-code]]
