...
- [[03-RESOURCES/sources/unlocking-the-cloudflare-app-ecosystem-with-oauth-for-all]] — Cloudflare Self-Managed OAuth: blue-green migration com queue-based revocation replay, zero-downtime
- [[03-RESOURCES/sources/huntington-bank-redacting-sensitive-data-from-400m-documents-with-aws]] — 400M+ documents redacted com 95%+ accuracy usando Textract + SageMaker + Step Functions
