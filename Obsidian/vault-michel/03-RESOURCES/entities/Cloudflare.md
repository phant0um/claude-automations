...
- **[2026-06-24]** Self-Managed OAuth aberto a todos developers, zero-downtime migration do OAuth engine — [[cloudflare-on-x-self-managed-oauth-is-now-available-to-all-developers-on-cloudflare-here-s-how-we-executed-a-zero-downtime-migration-of-our-core-oauth-engine-to-make-it-happen-httpst-cotodip6nqj4]]
