...
> A seção de Skills confirma o que [[03-RESOURCES/concepts/claude-code-tooling/claude-skills]] documenta: YAML frontmatter, path-based discovery, cinco fontes. O artigo adiciona o detalhe de que o campo `paths: ["*.tsx"]` ativa a skill só quando o agente toca arquivos correspondentes — relevante para construir skills contextuais.
...
- [[03-RESOURCES/concepts/claude-code-tooling/claude-agent-harness-architecture]] — conceito expandido
- [[03-RESOURCES/concepts/claude-code-tooling/claude-skills]] — extensão por Skills; path-based discovery confirmado
