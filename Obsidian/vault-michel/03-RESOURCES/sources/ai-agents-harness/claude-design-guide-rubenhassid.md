...
**Produto:** [[03-RESOURCES/concepts/claude-code-tooling/claude-design]] — produto separado em [claude.ai/design](https://claude.ai/design)
...
- [[03-RESOURCES/concepts/claude-code-tooling/claude-design]] — conceito central
- [[03-RESOURCES/entities/Ruben-Hassid]] — autor
- [[03-RESOURCES/entities/Claude-Cowork]] — usado no Step 1 do workflow avançado
- [[03-RESOURCES/concepts/claude-code-tooling/claude-research-mode]] — usado no Video Hack (gera markdown)
- [[03-RESOURCES/entities/Claude-Opus-47]] — modelo que roda o Claude Design (Opus 4.7)
- [[03-RESOURCES/concepts/ai-strategy-org/agentic-video]] — Claude Design cria vídeos animados via template
