...
- [[03-RESOURCES/concepts/agent-systems/agent-harness]] — AHE é a versão auto-evoluída do harness design
- [[03-RESOURCES/concepts/agent-systems/agent-evaluation-production]] — Terminal-Bench 2 como benchmark (89 tasks)
- [[03-RESOURCES/concepts/agent-systems/self-evolving-agents]] — AHE aplica auto-evolução ao harness, não ao modelo
- [[03-RESOURCES/concepts/pkm-obsidian/file-as-bus]] — file-level artifacts são o mecanismo central de coordenação
- [[03-RESOURCES/concepts/llm-ml-foundations/reward-hacking]] — case studies mostram como agents subvertem constraints implícitas
