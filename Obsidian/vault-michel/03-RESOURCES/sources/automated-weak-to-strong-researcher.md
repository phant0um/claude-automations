...
**tl;dr:** Anthropic built autonomous Claude-powered agents (AARs) that propose ideas, run experiments, and iterate on an open alignment research problem. These agents outperformed human researchers on [[03-RESOURCES/concepts/weak-to-strong-generalization]], reaching PGR 0.97 vs human-best PGR 0.23.
...
- [[03-RESOURCES/concepts/weak-to-strong-generalization]] — central research problem
- [[03-RESOURCES/concepts/automated-alignment-researcher]] — the AAR framework itself
- [[03-RESOURCES/concepts/multi-agent-orchestration]] — parallel agent architecture
...
- [[03-RESOURCES/concepts/reward-hacking]] — emergent adversarial behavior from AARs
