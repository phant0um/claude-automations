...
- [[03-RESOURCES/concepts/agentic-agents]] — o que é um AI agent; agentic loop
- [[03-RESOURCES/concepts/context-window]] — gerenciamento de contexto; compaction; /compact; /clear
- [[03-RESOURCES/concepts/claude-code-workflow]] — workflow EPCC completo
- [[03-RESOURCES/concepts/mcp-model-context-protocol]] — MCP em profundidade; tipos, escopos, context costs
- [[03-RESOURCES/entities/Claude Code]] — entidade principal; versões; uso neste vault
- [[03-RESOURCES/concepts/claude-hooks]] — hooks em profundidade; exit codes; casos de uso
- [[03-RESOURCES/concepts/mcp-model-context-protocol]] — MCP como padrão aberto
- [[03-RESOURCES/concepts/context-engineering]] — contexto focado como substituto de iteração
- [[03-RESOURCES/concepts/multi-agent-orchestration]] — padrões de coordenação entre agentes
