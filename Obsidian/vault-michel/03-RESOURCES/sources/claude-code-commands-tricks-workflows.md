...
| 02 | **/compact** | Comprime histórico da conversa em resumo focado após 30–45 min. Evita [[03-RESOURCES/concepts/context-rot]]. |
...
- Comandos de sessão conectam a [[03-RESOURCES/concepts/context-window]] (/compact, /clear) e [[03-RESOURCES/concepts/context-rot]]
- Plan Mode é o coração de [[03-RESOURCES/concepts/claude-code-workflow]] (EPCC)
- /init e /memory formam o núcleo de [[03-RESOURCES/concepts/claude-folder-anatomy]]
- Multi-Model Switching é instância de [[03-RESOURCES/concepts/multi-agent-orchestration]]
- Test-First + Incremental Build são práticas de [[03-RESOURCES/concepts/claude-power-user-framework]]
- Recovery Mode é estratégia de última instância quando [[03-RESOURCES/concepts/context-rot]] não é reversível com /compact
