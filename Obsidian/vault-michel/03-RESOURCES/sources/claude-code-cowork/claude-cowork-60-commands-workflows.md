...
Ver página canônica: [[03-RESOURCES/concepts/claude-code-tooling/cowork-slash-commands]]
...
Ver página canônica: [[03-RESOURCES/concepts/claude-code-tooling/claude-skills]]
...
Ver página canônica: [[03-RESOURCES/concepts/claude-code-tooling/cowork-scheduled-automations]]
...
- [[03-RESOURCES/concepts/claude-code-tooling/cowork-slash-commands]] — referência completa dos 12 comandos
- [[03-RESOURCES/concepts/claude-code-tooling/cowork-scheduled-automations]] — automações agendadas com exemplos
- [[03-RESOURCES/concepts/claude-code-tooling/claude-skills]] — SKILL.md format; marketplace; stacking
- [[03-RESOURCES/entities/Claude-Cowork]] — entidade: o produto em si
- [[03-RESOURCES/concepts/claude-code-tooling/claude-cowork-plugins]] — relação plugins vs skills no Cowork
- [[03-RESOURCES/concepts/pkm-obsidian/life-operating-system]] — Cowork como Life OS completo
- [[03-RESOURCES/concepts/claude-code-tooling/claude-folder-anatomy]] — `.claude/` folder convention (item 58)
- [[03-RESOURCES/concepts/llm-ml-foundations/context-window]] — `/compact` e `/clear` para gestão de contexto
- [[03-RESOURCES/concepts/agent-systems/subagent-spawning]] — parallelização via `/agents` (item 54)
