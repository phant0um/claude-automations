...
Plugin structure: plain folder of markdown + JSON, no build step. Everything is editable. See [[03-RESOURCES/concepts/claude-code-tooling/claude-cowork-plugins]] for full detail.
...
- Concept: [[03-RESOURCES/concepts/claude-code-tooling/claude-cowork-plugins]]
- Concept: [[03-RESOURCES/concepts/claude-code-tooling/cowork-scheduled-automations]]
- Concept: [[03-RESOURCES/concepts/claude-code-tooling/cowork-slash-commands]]
- Related sources: [[03-RESOURCES/sources/claude-code-cowork/cowork-setup-guide-coreyganim]] · [[03-RESOURCES/sources/claude-code-cowork/cowork-plugin-guide-coreyganim]] · [[03-RESOURCES/sources/claude-code-cowork/clipping-claude-cowork-ultimate-starter-pack-2026]]
