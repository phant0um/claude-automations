...
- [[03-RESOURCES/concepts/claude-folder-anatomy]] — `.claude/agents/` como componente da estrutura
- [[03-RESOURCES/concepts/subagent-spawning]] — comportamento de spawning no Opus 4.7
- [[03-RESOURCES/concepts/multi-agent-orchestration]] — padrões de orquestração e delegação
- [[03-RESOURCES/concepts/claude-skills]] — skills vs sub-agentes: diferenças e quando usar cada
