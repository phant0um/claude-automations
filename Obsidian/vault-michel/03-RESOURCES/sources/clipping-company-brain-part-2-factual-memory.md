...
→ This points to a [[03-RESOURCES/concepts/semantic-file-system]] rather than a retrieval layer.
...
- [[03-RESOURCES/concepts/agent-memory-architecture]] — individual agent memory layers (episodic/semantic/procedural); factual memory is the org-scale analog
- [[03-RESOURCES/concepts/agent-memory-four-layers]] — four-layer separation; Company Brain's factual memory adds provenance and permission layers absent from coding-agent memory models
- [[03-RESOURCES/concepts/company-brain]] — parent concept page
- [[03-RESOURCES/concepts/factual-memory]] — concept deep-dive
- [[03-RESOURCES/concepts/semantic-file-system]] — the storage model required
- [[03-RESOURCES/concepts/knowledge-compounding]] — why connected memory compounds in value
