...
- [[03-RESOURCES/concepts/claude-skills]] — `video-prompt-builder` is a SKILL.md-standard Claude skill
- [[03-RESOURCES/concepts/mcp-model-context-protocol]] — Higgsfield connected via MCP
- [[03-RESOURCES/concepts/agent-harness]] — Hermes as context/routing/memory harness layer
