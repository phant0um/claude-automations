...
- [[03-RESOURCES/concepts/claude-code-workflow]] — workflow orchestration
- [[03-RESOURCES/concepts/claude-hooks]] — system automation
- [[03-RESOURCES/concepts/prompt-caching]] — token efficiency
- [[03-RESOURCES/concepts/context-engineering]] — context optimization
- [[03-RESOURCES/concepts/mcp-model-context-protocol]] — API + MCP integration strategy
- [[03-RESOURCES/concepts/multi-agent-orchestration]] — delegation patterns
