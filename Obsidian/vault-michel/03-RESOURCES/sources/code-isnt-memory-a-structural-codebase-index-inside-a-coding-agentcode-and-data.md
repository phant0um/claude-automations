...
## Minha Síntese
**O que muda:** Este estudo reforça que coding agents now interleave llms with retrieval over the working repository, and retrieval implementations vary widely  — impacta diretamente como projetar e avaliar agentes.
