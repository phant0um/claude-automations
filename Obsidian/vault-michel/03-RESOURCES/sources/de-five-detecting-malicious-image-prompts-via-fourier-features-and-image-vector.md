...
## Minha Síntese
**O que muda:** Este estudo reforça que vision language models (vlms) employ both visual and textual modalities to enable advanced vision–language inference. ho — impacta diretamente como projetar e avaliar agentes.
