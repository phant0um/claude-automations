...
## Conexões no Vault
- [[03-RESOURCES/concepts/claude-skills]] — SKILL.md é o padrão que ECC amplifica massivamente
- [[03-RESOURCES/concepts/claude-hooks]] — hooks de sessão são a espinha dorsal do ECC
- [[03-RESOURCES/concepts/claude-folder-anatomy]] — ECC vive em `.claude/` e `~/.claude/`
- [[03-RESOURCES/concepts/claude-agent-harness-architecture]] — ECC é o harness performance system
- [[03-RESOURCES/concepts/autonomous-learning]] — Continuous Learning v2 via instincts
