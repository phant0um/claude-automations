...
> Bayes' Theorem é o mesmo Teorema de Bayes que fundamenta o Naive Bayes no [[03-RESOURCES/concepts/dev-foundations/ciencia-de-dados]]. A intuição é idêntica: atualizar probabilidades com novas evidências.

> [!key-insight] Conexão com prediction-markets
> Este artigo aprofunda o [[03-RESOURCES/concepts/finance-trading/prediction-markets]] com implementações quantitativas concretas — o "edge" em lag de dados que a página menciona é exatamente isso.

## Links internos

- [[03-RESOURCES/concepts/finance-trading/prediction-markets]] — conceito base; este artigo fornece o toolkit quantitativo
- [[03-RESOURCES/entities/Polymarket]] — plataforma onde estas estratégias são aplicadas
- [[03-RESOURCES/concepts/llm-ml-foundations/bayesian-reasoning]] — Bayes expandido
- [[03-RESOURCES/concepts/finance-trading/kelly-criterion]] — Kelly expandido
- [[03-RESOURCES/concepts/dev-foundations/ciencia-de-dados]] — Naive Bayes usa o mesmo teorema
