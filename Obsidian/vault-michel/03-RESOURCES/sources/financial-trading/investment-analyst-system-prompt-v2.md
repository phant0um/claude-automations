...
5. **Compactação programática** — /compact automático após 10 turnos; análogo ao [[03-RESOURCES/concepts/llm-ml-foundations/context-rot|context rot]] management

---

## Conexões

- [[03-RESOURCES/concepts/llm-ml-foundations/prompt-caching]] — bloco estável usa `cache_control ephemeral`; pattern de prefix imutável
- [[03-RESOURCES/concepts/llm-ml-foundations/context-rot]] — compactação após 10 turnos como solução para context rot
- [[03-RESOURCES/concepts/llm-ml-foundations/context-engineering]] — estado visível como contexto explícito (não implícito)
- [[03-RESOURCES/concepts/agent-systems/financial-services-agents]] — domain agent para mercados BR+EUA
- [[03-RESOURCES/concepts/agent-systems/multi-agent-orchestration]] — model routing por complexidade (Sonnet vs Haiku)
