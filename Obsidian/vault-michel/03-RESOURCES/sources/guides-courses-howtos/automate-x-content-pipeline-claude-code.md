...
O arquivo [[03-RESOURCES/concepts/claude-code-tooling/claude-folder-anatomy|CLAUDE]] é o componente central. Define:
- **Three-layer architecture:** directives → orchestration → execution
- Claude verifica scripts existentes antes de escrever novos
- **Self-annealing loop:** quando algo quebra, Claude lê o erro, corrige o script, e atualiza a diretiva para evitar a mesma falha — equivalente a [[03-RESOURCES/concepts/agent-systems/self-evolving-agents]]
...
- [[03-RESOURCES/concepts/claude-code-tooling/claude-folder-anatomy]] — CLAUDE.md como arquitetura central
- [[03-RESOURCES/concepts/claude-code-tooling/claude-code-workflow]] — padrão EPCC e uso de scripts determinísticos
- [[03-RESOURCES/concepts/pkm-obsidian/life-operating-system]] — automação de fluxos repetitivos via Claude Code
- [[03-RESOURCES/concepts/agent-systems/self-evolving-agents]] — self-annealing loop é análogo estrutural
- [[03-RESOURCES/concepts/claude-code-tooling/claude-agent-harness-architecture]] — separação decisão (IA) / execução (código)
- [[03-RESOURCES/concepts/ai-strategy-org/content-automation-pipeline]] — conceito criado nesta ingestão
