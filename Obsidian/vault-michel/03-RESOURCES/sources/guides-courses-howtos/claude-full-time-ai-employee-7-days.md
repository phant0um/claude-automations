...
- [[03-RESOURCES/concepts/claude-code-tooling/claude-projects]] — memória cross-session
- [[03-RESOURCES/concepts/agent-systems/agentic-agents]] — arquétipos de AI employee
