...
- [[03-RESOURCES/concepts/crypto-trading-agent]] — conceito central
- [[03-RESOURCES/concepts/claude-skills]] — SKILL.md é o padrão de estratégias do OpenClaw
- [[03-RESOURCES/concepts/multi-agent-orchestration]] — OpenClaw usa orchestrator + sub-agents
- [[03-RESOURCES/sources/claude-tradingview-full-guide]] — outro guia de trading AI (TradingView MCP)
- [[03-RESOURCES/concepts/prediction-markets]] — infraestrutura relacionada
