...
## Minha Síntese
**O que muda:** Este estudo reforça que [deep agents]() is an agent harness built on [langgraph](), for agents that need to work through a task over many steps  — impacta diretamente como projetar e avaliar agentes.
