...
2. **[[03-RESOURCES/concepts/context-rot]]** — modelos ficam menos inteligentes com contextos longos (atenção diluída). O review agent começa com contexto limpo, apenas o diff, e re-descobre contexto necessário lendo o código do zero
...
**Takeaway:** Clean context → melhoria notável em capabilities no [[03-RESOURCES/concepts/generator-verifier-loop]]. Mas síntese clara com contexto global é essencial para experiência coesa.
...
- [[03-RESOURCES/concepts/context-rot]] — fenômeno documentado pela Chroma
- [[03-RESOURCES/concepts/multi-agent-orchestration]] — padrões de coordenação
- [[03-RESOURCES/concepts/generator-verifier-loop]] — conceito criado nesta ingestão
