...
- [[03-RESOURCES/concepts/multi-principal-agent]] — conceito central formalizado aqui
- [[03-RESOURCES/concepts/multi-agent-orchestration]] — orquestração de múltiplos agentes (perspectiva diferente)
- [[03-RESOURCES/concepts/agent-memory-architecture]] — memória e contexto em agentes
- [[03-RESOURCES/concepts/context-engineering]] — gestão de contexto
