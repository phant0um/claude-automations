...
- [[03-RESOURCES/concepts/life-operating-system]] — extensão natural do Life OS pattern
- [[03-RESOURCES/concepts/second-brain]] — evolução para Business Operating System
- [[03-RESOURCES/concepts/claude-hooks]] — N8N como equivalente externo de hooks internos
- [[03-RESOURCES/concepts/mcp-model-context-protocol]] — read/write access aos arquivos via MCP
