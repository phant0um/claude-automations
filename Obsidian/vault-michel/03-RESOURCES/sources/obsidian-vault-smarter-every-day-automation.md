...
- [[03-RESOURCES/sources/jarvis-obsidian-claude-code-cyrilxbt]] — guia anterior do mesmo autor (@cyrilXBT): vault JARVIS para produção de conteúdo, mesma camada Claude + CLAUDE.md, foco diferente (content system vs knowledge feedback loop)
- [[03-RESOURCES/sources/jarvis-obsidian-second-brain-thinks-full-setup]] — guia estruturalmente idêntico por @DamiDefi; mesma arquitetura de pastas, mesmas 4 skills, mesmo ritual diário
- [[03-RESOURCES/concepts/self-improving-vault]] — conceito extraído: vault que melhora com o tempo sem esforço manual
- [[03-RESOURCES/concepts/scheduled-ingest-routine]] — conceito extraído: rotina de ingestão automática via cron
- [[03-RESOURCES/concepts/knowledge-compounding]] — base teórica do efeito composto ao longo do tempo
- [[03-RESOURCES/concepts/second-brain]] — conceito fundacional PKM
- [[03-RESOURCES/concepts/obsidian-jarvis-content-system]] — sistema complementar (foco em conteúdo)
- [[03-RESOURCES/concepts/context-engineering]] — CLAUDE.md como núcleo de contexto rico
- [[03-RESOURCES/concepts/cowork-scheduled-automations]] — padrão de automações agendadas (N8N equivalente ao Cowork scheduler)
