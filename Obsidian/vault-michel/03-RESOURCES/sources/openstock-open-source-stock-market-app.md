...
- [[03-RESOURCES/concepts/open-source-fintech]] — OpenStock como caso de estudo de fintech open-source
...
- [[03-RESOURCES/concepts/crypto-trading-agent]] — domínio adjacente (trading agents)
- [[03-RESOURCES/concepts/mcp-model-context-protocol]] — integração potencial para dados de mercado em tempo real
