...
- [[03-RESOURCES/concepts/open-source-fintech]] — conceito novo
- [[03-RESOURCES/entities/Open-Dev-Society]] — organização por trás do projeto
- Usa [[03-RESOURCES/concepts/mcp-model-context-protocol]] via Finnhub e TradingView (analogia ao [[03-RESOURCES/entities/TradingView-MCP]])
- Inngest para automação = mesmo padrão de [[03-RESOURCES/concepts/multi-agent-orchestration]] (event-driven workflows)
- AI-personalized email via Gemini = instância de [[03-RESOURCES/concepts/context-engineering]] aplicado a comunicação
