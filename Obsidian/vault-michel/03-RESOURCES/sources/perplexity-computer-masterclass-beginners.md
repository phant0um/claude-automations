...
- [[03-RESOURCES/concepts/multi-model-orchestration]] — conceito central (19 modelos, roteamento por subtarefa)
- [[03-RESOURCES/concepts/agentic-agents]] — definição agent vs chatbot
- [[03-RESOURCES/concepts/claude-connectors]] — padrão de conectores OAuth (Claude tem conceito análogo)
