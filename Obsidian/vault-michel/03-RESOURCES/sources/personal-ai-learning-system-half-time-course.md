...
- [[03-RESOURCES/concepts/ai-tutor-pattern]] — the architectural pattern this system instantiates
- [[03-RESOURCES/concepts/socratic-learning-loop]] — Module 2 formalized as a concept
- [[03-RESOURCES/concepts/spaced-learning-llm]] — Module 3 formalized
- [[03-RESOURCES/concepts/personal-curriculum]] — the diagnostic-driven individualized path
- [[03-RESOURCES/concepts/skill-development]] — broader skill-building framework; this source is an application layer
- [[03-RESOURCES/concepts/autonomous-learning]] — human-side corollary; agent autonomous learning vs. human AI-assisted learning
- [[03-RESOURCES/concepts/prompt-engineering-patterns]] — the prompts here are high-quality reusable patterns
