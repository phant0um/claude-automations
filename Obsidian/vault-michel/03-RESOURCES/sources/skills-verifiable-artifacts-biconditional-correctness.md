...
- [[03-RESOURCES/concepts/claude-skills]] — SKILL.md as the artifact this paper secures
- [[03-RESOURCES/concepts/agentic-skills]] — broader skills ecosystem
- [[03-RESOURCES/concepts/agent-harness]] — the runtime that must enforce the schema
- [[03-RESOURCES/sources/heavyskill-heavy-thinking-agentic-harness]] — companion paper on skill capability
- [[03-RESOURCES/concepts/multi-agent-orchestration]] — HITL governance in orchestration
