...
### [[03-RESOURCES/concepts/file-as-bus]] — File-as-Bus Protocol
...
### [[03-RESOURCES/concepts/hierarchical-orchestration]] — Agent-as-Tool
...
- [[03-RESOURCES/concepts/multi-agent-orchestration]] — AiScientist é implementação avançada deste padrão
- [[03-RESOURCES/concepts/context-engineering]] — File-as-Bus é solução específica de context engineering para long-horizon
- [[03-RESOURCES/concepts/agent-memory-architecture]] — durable artifacts = memória externa persistente
- [[03-RESOURCES/concepts/file-as-bus]] — conceito central deste paper
- [[03-RESOURCES/concepts/hierarchical-orchestration]] — thin control over thick state
