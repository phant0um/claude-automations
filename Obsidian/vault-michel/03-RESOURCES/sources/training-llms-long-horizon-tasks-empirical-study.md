...
- [[03-RESOURCES/concepts/agentic-rl]] — this paper adds horizon-length analysis; update with instability findings
- [[03-RESOURCES/concepts/horizon-length]] — new concept extracted from this paper
- [[03-RESOURCES/concepts/horizon-reduction]] — new concept: macro actions + subgoal decomposition
- [[03-RESOURCES/concepts/credit-assignment]] — new concept: sparse reward + negative advantage dynamics
- [[03-RESOURCES/concepts/post-training-llm]] — SFT → RL pipeline described here
