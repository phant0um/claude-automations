...
Índice navegável de todos os agentes do vault. **[Migração concluída 2026-05-14 para estrutura categorizada]** → Ver `[[04-SYSTEM/agents/_index/ai-agents-index]]`

---

## Core (Vault SO + Feature Dev)

- [[04-SYSTEM/agents/00-core/guard]] — Segurança (OWASP LLM Top 10) · Opus
- [[04-SYSTEM/agents/00-core/review]] — Drift review · Haiku
- [[04-SYSTEM/agents/00-core/verify]] — Quality gate · Sonnet
- [[04-SYSTEM/agents/00-core/ingest-report]] — Relatório semanal · Haiku
- [[04-SYSTEM/agents/00-core/spec]] — Spec-Driven Development · Haiku
- [[04-SYSTEM/agents/00-core/extend]] — Extensão cirúrgica · Sonnet
- [[04-SYSTEM/agents/00-core/hill]] — Hill-climbing de agentes · Haiku
...
- [[04-SYSTEM/agents/standalone/mtg-arena-coach|MTG Arena Coach]] — Coach de MTG Arena
...
- [[04-SYSTEM/agents/04-infrastructure/claude-hermes-proxy]] — Proxy OpenAI-compat
...
**Referência oficial:** `[[04-SYSTEM/agents/_index/ai-agents-index]]` (version-controlled index)
