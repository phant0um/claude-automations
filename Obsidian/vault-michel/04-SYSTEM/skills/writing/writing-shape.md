...
trigger_pt: ["escrever artigo", "rascunho", "redação", "fragmentos", "moldar texto"]
---
...
## Citation-verify (opendraft)

Antes de afirmar fato com fonte, verificar contra CrossRef/OpenAlex/arXiv; sem match →
marcar `[não-verificado]`. Reforça grounding. Liga a hallucination-gate (T15) e
cite-or-flag (T40).
