...
![](https://cf-assets.www.cloudflare.com/zkvhlag99gkb/25KzBWgTy4UfdPbzJOg1lO/9c179230f783e9012624a8a9d99b7dac/image4.png)

<sup><i>The pipe represents a socket connection between the intermediary and Images, where data is handed off from one process to the next through the kernel’s buffer.</i></sup>
...
![](https://cf-assets.www.cloudflare.com/zkvhlag99gkb/2K8AiqgOV7Ka7uUUAnk5x0/ca1cc575e08b103ebb677ef66df7e87b/image2.png)

<sup><i>The bug originated in the inner pipeline’s return path, where the response was truncated before reaching the outer pipeline.</i></sup>
...
![](https://cf-assets.www.cloudflare.com/zkvhlag99gkb/7IaYVui9xakhcroOBifwmO/c22c004bcb85c7efe38f318b9db92a3f/image3.png)

<sup><i>When the reader consumes slower than hyper writes, the outbound buffer fills up. If hyper shuts down the connection before the buffer drains, then only a fraction of the response makes it to the intermediary; this incomplete data gets forwarded back to the Workers runtime and the client.</i></sup>
...
[Image Optimization](https://blog.cloudflare.com/tag/image-optimization/) [Cloudflare Images](https://blog.cloudflare.com/tag/cloudflare-images/) [Developers](https://blog.cloudflare.com/tag/developers/) [Developer Platform](https://blog.cloudflare.com/tag/developer-platform/) [Cloudflare Workers](https://blog.cloudflare.com/tag/workers/) [Open Source](https://blog.cloudflare.com/tag/open-source/)